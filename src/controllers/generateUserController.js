...
async function processRow(row, tx) {
  ...
  const profile = await tx.profile.create({
    data: {
      ...
      image: `https://yarsi-connect-alumni-backend.vercel.app/uploads/private/profiles/default-profile.png`,
  ...
  try {
    ...
    const profile = await prisma.profile.create({
      data: {
        ...
        studyProgram: { connect: { id: studyProgramRecord.id } },
        year_graduated: null,
        image: `https://yarsi-connect-alumni-backend.vercel.app/uploads/private/profiles/default-profile.png`, // Path lokal
